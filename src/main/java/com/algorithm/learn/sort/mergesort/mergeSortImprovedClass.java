 ...
 */
public class mergeSortImprovedClass {

    /**
     * 总结：
     * 1.排序时间：10000个数字排序，array 排序耗时：7ms
     */
     ...
     * 改进：
     * （1）array[mid]<=array[mid+1]时，时不需要merge的，自动排序。所以，添加一个判断
     *
     * @param array
     * @param left
     * @param right
    ...
    public static void mergeSort(int[] array,int left,int right){
        ...
        //改进（1）：当array[mid]<array[mid+1]时，是不需要排序的。
    ...
    /**
     * 0.1:
     * 功能：将array[i]中， left<=i<=mid 和 mid+1<=i<=right 两个部分，进行归并
     *
     * @param array
     * @param left
     * @param mid
